<template>
    <main class="w-full">
        <section>
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex" aria-label="Tabs">
                    ...
                    <NuxtLink :href="`/${tableid}/agent`" class="w-1/3 border-b-2 border-indigo-500 px-1 py-4 text-center text-lg font-medium text-indigo-600" aria-current="page">
                        Agent
                    </NuxtLink>
                </nav>
            </div>
        ...
        <p class="mx-3 my-5 p-5 text-lg tracking-wider text-slate-600 leading-7 bg-amber-100 rounded-xl border border-amber-300 shadow">
        ...
        <!-- <section class="px-3 py-5">
            ...
            <div class="mt-6 flex gap-x-3">
                ...
                <form action="javascript://" class="relative flex-auto">
                    <div class="overflow-hidden rounded-lg pb-12 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                        <label htmlFor="comment" class="sr-only">Add your comment</label>
                        <textarea
                            rows={2}
                            name="comment"
                            id="comment"
...
const frame = {
    ...
    button: {
        ...
        action: {
            type: 'launch_frame',
            name: `Open Agent`,
            url: `https://cast.poker/${tableid.value}/agent/`,
