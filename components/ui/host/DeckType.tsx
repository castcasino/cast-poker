...
console.log('DECK TYPE', value)
    ...
    --> */}
                    <label onClick={() => onClick('single')} aria-label="Standard" aria-description="4–10 business days for $5.00" class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none border-transparent ring-2 ring-lime-500">
                        ...
                        <span class="flex flex-1">
                            <span class="flex flex-col">
                                ...
                                <span class="mt-6 text-sm font-medium text-gray-900 tracking-wide">
        ...
        Active: "ring-2 ring-lime-500"
    --> */}
                    <label onClick={() => onClick('wagmi')} aria-label="Express" aria-description="2–5 business days for $16.00" class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none border-gray-300 opacity-50">
