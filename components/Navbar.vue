<template>
    <main class="w-full sm:w-[640px] mx-auto h-[45px] z-10 flex justify-end sm:justify-between items-center bg-slate-700 border-t-[3px] border-amber-400">
        ...
        <div class="h-full flex flex-row">
            ...
            <NuxtLink :href="`/${props.tableid}/lounge`" class="group h-full flex items-center px-3 bg-slate-200 border-x border-amber-400 hover:bg-amber-600">
                <span class="text-lg font-bold text-slate-800 tracking-tight sm:tracking-widest uppercase group-hover:text-slate-200">
                    Lobby
                </span>
            </NuxtLink>

            <NuxtLink :href="`/${props.tableid}/share`" class="group h-full flex items-center px-3 bg-slate-200 border-x border-amber-400 hover:bg-amber-600">
                <span class="text-lg font-bold text-slate-800 tracking-tight sm:tracking-widest uppercase group-hover:text-slate-200">
                    Earn<span class="text-lime-500 font-bold">＄</span>
                </span>
            </NuxtLink>

            <NuxtLink :href="`/${props.tableid}/faq`" class="group h-full flex items-center px-3 bg-slate-200 border-x border-amber-400 hover:bg-amber-600">
                <span class="text-lg font-bold text-slate-800 tracking-tight sm:tracking-widest uppercase group-hover:text-slate-200">
                    Help?
                </span>
            </NuxtLink>
            ...
            <NuxtLink :href="`/${props.tableid}`" class="group h-full flex items-center px-3 bg-slate-200 border-x border-amber-400 hover:bg-amber-600">
                <span class="text-lg font-bold text-slate-800 tracking-tight sm:tracking-widest uppercase group-hover:text-slate-200">
                    Table
                </span>
            </NuxtLink>
