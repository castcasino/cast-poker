                        ...
                        <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                            ...
                            <div class="mx-auto mt-10 max-w-sm sm:flex sm:max-w-none sm:justify-center">
                                <div class="space-y-4 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5 sm:space-y-0">
                                    <NuxtLink to="/leaderboard" class="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-2xl font-medium text-indigo-700 shadow-sm hover:bg-indigo-50 sm:px-8">
                        ...
                        <div class="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
                            <div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <p class="mt-4 text-lg text-gray-500">
                                        The <span class="font-medium text-indigo-500">Cast Poker Peer-review Network (NGPN)</span> allows our Players to receive the MOST up-to-date and accurate safety &amp; security assurances from the MOST trusted names in Crypto gaming.
                                    </p>
            ...
            <div class="bg-white">
                <div class="mx-auto max-w-4xl py-16 px-4 sm:px-6 sm:py-24 lg:flex lg:max-w-7xl lg:items-center lg:justify-between lg:px-8">
                    <h2 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                        <span class="block">
                            Ready for more Fairplay gaming?
                        </span>
